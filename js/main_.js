...
const $modalInput = document.querySelector('.player');
const $modalBtn = document.querySelector('button.modal_btn');
...
//   let number = Number($modalInput.value)
...
const onClickButton = () => {
  ...
  //추가
  let inputWord = document.querySelector('input.answer').value;
...
$modalBtn.addEventListener('click', onClickButton);
